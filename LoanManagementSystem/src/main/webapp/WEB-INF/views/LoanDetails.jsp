...
<div class="container">
    ...
    <form action="submitApp" method="get" onsubmit="storeFormData()">
        ...
        <div id="LoanApplicant" class="tabcontent">
            ...
            <br> <label for="lnapannualincome">Annual Income:</label> <input type="number" id="lnapannualincome" name="lnapannualincome" required><br>
            <br> <label for="lnapdisposalincome">Disposal Income:</label> <input type="number" id="lnapdisposalincome" name="lnapdisposalincome" required><br>
        ...
        <br> <br>
        <center>
            <input onsubmit="reset" type="submit" value="Go to preview">
        </center>
    </form>
</div>
<script>
